...
CREATE TABLE `movies` (
  ...
  `movielines` text CHARACTER SET latin1 NOT NULL
...
(4, 'images/icon-nutrition.jepg', '1917', 'The story is set during the Second World War. It tells the story of the boy Jojo and his mother living under Nazi Germany, but the mother secretly helped the innocent Jewish girl, so it also changed the story of Jojo.'),
